...
//  TechChallengeTests
//
//  Created by Ronald Aviles on 9/16/21.
//
//
...
struct SampleData {
    ...
    static let sampleFoodTransactions: [TransactionModel] = [
        TransactionModel(
            id: 3,
            name: "Salad Mix",
            category: .food,
    ...
    static let sampleHealthTransactions: [TransactionModel] = [
        TransactionModel(
            id: 8,
            name: "Meds",
            category: .health,
    ...
    static let sampleEntertainmentTransactions: [TransactionModel] = [
        TransactionModel(
            id: 1,
            name: "Movie Night",
    ...
    static let sampleShoppingTransactions: [TransactionModel] = [
        TransactionModel(
            id: 2,
            name: "Jeans",
            category: .shopping,
    ...
    static let sampleTravelTransactions: [TransactionModel] = [
        TransactionModel(
            id: 5,
            name: "Airport ride",
            category: .travel,
    ...
    static let sampleAllTransactions: [TransactionModel] = [
        TransactionModel(
            id: 1,
            name: "Movie Night",
            category: .entertainment,
